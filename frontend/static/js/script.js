...
const dateIn = searchForm.querySelector("[name=arrival_date]");
const dateOut = searchForm.querySelector("[name=departure_date]");
const adults = searchForm.querySelector("[name=number_of_adults]");
const kids = searchForm.querySelector("[name=number_of_children]");
